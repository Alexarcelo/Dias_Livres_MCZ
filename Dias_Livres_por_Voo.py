...
def gerar_df_phoenix(vw_name, base_luck):
    ...
    request_name = f'SELECT `Status do Servico`, `Status da Reserva`, `Data Execucao`, `Servico`, `Reserva`, `Total ADT`, `Total CHD`, `Tipo de Servico`, `Voo`, `Horario Voo`, `Est Destino`, `Cliente`, `Telefone Cliente`, `Parceiro` FROM {vw_name}'
